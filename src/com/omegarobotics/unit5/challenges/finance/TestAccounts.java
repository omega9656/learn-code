...
public class TestAccounts {
  ...
  public static void main(String[] args) {
    ...
    accounts[2] =
      new CreditCardAccount("Jesper", 51782737, 7000.00, 0.08, 1000.00);
    accounts[3] =
      new CreditCardAccount("Wylan", 629553328, 1500.00, 0.075, 5000);
    accounts[4] =
      new CreditCardAccount("Nina", 4977201043L, -5000.00, 0.07, 10000);
    ...
    for (Account acct : accounts) {
      ...
      System.out.println(
        acct.getName() + "'s balance after deposit: " + acct.getBalance()
      );
      acct.withdraw(WITHDRAW_AMOUNT);
      System.out.println(
        acct.getName() + "'s balance after withdrawal: " + acct.getBalance()
      );
