...
An employee has an office address, salary, employee ID number (long), and date hired (MyDate).
    ...
    Define the employee ID number and date hired as constants.
...
All fields should be private. All methods should be public. Unless otherwise specified,
...
stores them in a Person[] array, and prints all of them.
