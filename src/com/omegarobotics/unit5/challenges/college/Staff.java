...
public class Staff extends Employee {
	 ...
	 */
	public Staff(String officeAddress, double salary, long EMPLOYEE_ID_NUMBER, MyDate DATE_HIRED) {
	 ...
	 */
	public Staff(String name, String address, long phoneNumber, String emailAddress,
