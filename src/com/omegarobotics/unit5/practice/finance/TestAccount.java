...
public class TestAccount {
    public static void main(String[] args) {
        ...
        System.out.println("Transfer successful: " + pirateShipFund.transferTo(college, 13_523));
        System.out.println("college balance: " + college.getBalance());
        System.out.println("pirate ship fund balance: " + pirateShipFund.getBalance());
        ...
        System.out.println("college balance after withdrawal: " + college.getBalance());

        // test remaining getters
        System.out.println("pirate ship fund name: " + pirateShipFund.getName());
        System.out.println("pirate ship fund number: " + pirateShipFund.getNumber());
